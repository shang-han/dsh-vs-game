...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const MV_ITEM_NAMES = {
			...
			'skill-fragment-teleport': '传送激光碎片', 'skill-fragment-damage': '伤害激光碎片',
			'skill-book-teleport': '技能书·传送激光', 'skill-book-damage': '技能书·伤害激光',
		};
		...
		const ITEM_DEFS = {
			...
			'skill-fragment-teleport': { icon: '📘', iconUrl: '/vs-game/assets/items/mv/mat-scroll.png', name: '传送激光碎片', type: 'material', desc: '第二关 Boss 掉落，收集 10 个合成传送激光技能书' },
			...
			'skill-book-teleport': { icon: '📖', iconUrl: '/vs-game/assets/items/skill_book.png', name: '技能书·传送激光', type: 'consumable', desc: '使用后学会主动技能「传送激光」' },
...
const BAG_STORAGE_KEY = 'dsh-vs-game-bag-slots-v1';
		...
		const CRAFT_RECIPES = [
			...
			{ product: 'skill-book-teleport', need: { 'skill-fragment-teleport': 10 }, name: '技能书·传送激光' },
