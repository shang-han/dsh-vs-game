...
const BAG_STORAGE_KEY = 'dsh-vs-game-bag-slots-v1';
		...
		class GameEngine {
			...
			enderBurst(x, y) {
				this.burst(x, y, '#b46bff', 44);
				this.particles.push({ kind: 'enderPillar', x, y, life: 0.65, maxLife: 0.65 });
				for (let i = 0; i < 12; i++) {
					this.particles.push({ kind: 'ender', x, y, life: 0.7 + i * 0.045, maxLife: 1.25, color: '#b46bff', size: 30 + i * 8 });
				}
			}
