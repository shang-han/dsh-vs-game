		...
		class GameEngine {
			...
			drawHome(c, t) {
				...
				if (furniture.complete && furniture.naturalWidth) {
					// 柜子：row4 col10 + row5 col10 竖拼，放在床左侧
					c.drawImage(furniture, 10 * 48, 4 * 48, 48, 48, 336, 240, 48, 48);
					c.drawImage(furniture, 10 * 48, 5 * 48, 48, 48, 336, 288, 48, 48);
					// Large Bed：竖着拼两格，源/目标都是 row5 col8 + row6 col8，不旋转
					c.drawImage(furniture, 8 * 48, 5 * 48, 48, 48, 384, 240, 48, 48);
					c.drawImage(furniture, 8 * 48, 6 * 48, 48, 48, 384, 288, 48, 48);
				} else {
					c.fillStyle = '#4a2e1d';
