...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const PASSIVES = {
			...
			speed:  { icon: '👟', name: '加速', desc: '移速 +10% / 级' },
			might:  { icon: '💪', name: '力量', desc: '全伤害 +20% / 级' },
			haste:  { icon: '⏱', name: '冷却', desc: '武器冷却 -10% / 级' },
			...
			const renderPanel = () => {
				...
				return hs('div', { className: 'dsh-vs-char-panel', children: [
					...
					h('div', { key: 'hp', className: 'dsh-vs-upgrade-row', children: [
						h('span', { key: 'k', className: 'dsh-vs-upgrade-name', children: '角色血量' }),
