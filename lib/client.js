			...
			return hs('div', {
				...
				cfgOpen && cfg ? hs('div', { key: 'pop', className: 'dsh-vs-pop', children: [
					...
					h('div', { key: 'upd', className: 'dsh-vs-upd', children: [
						...
						updateInfo?.ok && updateInfo.latest && !updateInfo.isLatest ? h('button', { key: 'pull', className: 'dsh-vs-mini-btn', disabled: updating, onClick: pullUpdate, children: updating ? '更新中…' : '拉取更新' }) : null,
					] }),
				] }) : null,
