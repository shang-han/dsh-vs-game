				...
				hs('div', { key: 'box', className: 'dsh-vs-char-box', children: [
					...
					hs('div', { key: 'body', className: 'dsh-vs-char-body', children: [
						hs('div', { key: 'left', className: 'dsh-vs-char-left', children: [
							...
							h('div', { key: 'wt', className: 'dsh-vs-char-section-title', children: '初始武器' }),
							hs('div', { key: 'wg', className: 'dsh-vs-weapon-grid', children: Object.keys(WEAPONS).map((t) =>
								h('button', {
									key: t,
							...
							h('div', { key: 'at', className: 'dsh-vs-char-section-title', children: '饰品栏（4）' }),
							hs('div', { key: 'slots', className: 'dsh-vs-slots', children: accessories.map((a, i) =>
								h('div', { key: i, className: 'dsh-vs-slot', children: a || '未装备' })) }),
							h('div', { key: 'sk', className: 'dsh-vs-char-section-title', children: '主动技能' }),
							h('div', { key: 'active', className: 'dsh-vs-slot active', children: char.activeSkill || '待开发' }),
						]}),
						hs('div', { key: 'right', className: 'dsh-vs-char-right', children: [
							h('div', { key: 'it', className: 'dsh-vs-char-section-title', children: '背包' }),
							inventory.length > 0
								? hs('div', { key: 'inv', className: 'dsh-vs-inv', children: inventory.map(renderItem) })
								: h('div', { key: 'empty', className: 'dsh-vs-empty', children: '背包空空如也' }),
							h('div', { key: 'pt', className: 'dsh-vs-char-section-title', children: '初始被动' }),
							hs('div', { key: 'passives', className: 'dsh-vs-passives', children: Object.keys(PASSIVES).map((t) => {
