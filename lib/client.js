...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const ITEM_META = {
			...
			'skill-book': { icon: '📖', iconUrl: '/vs-game/assets/items/skill_book.png', name: '技能书·Token弹', desc: '可解锁主动技能槽' },
			'skill-book-open': { icon: '📖', iconUrl: '/vs-game/assets/items/skill_book_open.png', name: '技能书·翻开的', desc: '可解锁主动技能槽' },
			'potion-red': { icon: '🧪', iconUrl: '/vs-game/assets/items/potion_red.png', name: '治疗药水', desc: '战斗中恢复 HP' },
			'potion-blue': { icon: '🧪', iconUrl: '/vs-game/assets/items/potion_blue.png', name: '蓝药水', desc: '战斗中恢复能量' },
			'gem-ruby': { icon: '💎', iconUrl: '/vs-game/assets/items/gem_ruby.png', name: '红宝石', desc: '可镶嵌饰品栏' },
			'gem-emerald': { icon: '💎', iconUrl: '/vs-game/assets/items/gem_emerald.png', name: '绿宝石', desc: '可镶嵌饰品栏' },
		};
		...
		function CharacterModal({ character, goldEarned, send, onClose }) {
			...
			const char = character || {
				...
				inventory: ['newbie-gift', 'skill-book', 'potion-red', 'gem-ruby'],
