		...
		class GameEngine {
			...
			buildHomeItems() {
				...
				const items = [
					...
					{ id: 'gallery', x: 528, y: 24, icon: '🖼️', label: '书架', noEmoji: true },
					{ id: 'table', x: 576, y: 24, icon: '🪑', label: '', noEmoji: true },
					{ id: 'chair', x: 576, y: 72, icon: '🪑', label: '', noEmoji: true },
					{ id: 'manual', x: 576, y: 20, icon: '📖', label: '手册', noEmoji: true },
