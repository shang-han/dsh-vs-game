		...
		class GameEngine {
			...
			buildHomeItems() {
				const items = [
					...
					{ id: 'dex', x: 456, y: 216, icon: '📚', label: '图鉴', noEmoji: true },
			...
			drawHome(c, t) {
				...
				if (furniture.complete && furniture.naturalWidth) {
					c.drawImage(furniture, 14 * 48, 3 * 48, 48, 48, 432, 192, 48, 48);
					c.drawImage(furniture, 15 * 48, 3 * 48, 48, 48, 480, 192, 48, 48);
					c.drawImage(furniture, 14 * 48, 4 * 48, 48, 48, 432, 240, 48, 48);
					c.drawImage(furniture, 15 * 48, 4 * 48, 48, 48, 480, 240, 48, 48);
				}
				c.restore();
			}
