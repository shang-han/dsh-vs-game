	...
	factory: (require) => {
		...
		function LevelSelect({ levels, character, onPick, onBack }) {
			...
			return hs('div', { className: 'dsh-vs-cover', children: [
				...
				h('div', { key: 'list', className: 'dsh-vs-levels', children: levels.map((lv) =>
					hs('div', { key: lv.id, className: 'dsh-vs-lvcard', onClick: () => onPick(lv), children: [
						cleared.has(lv.id) ? h('span', { key: 'b', className: 'badge', children: '✓ 已通关' }) : null,
